  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span.cst 3
      h1 Empaque y almacenamiento

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-4.mb-sm-4(data-aos="fade-right")
        figure
          img(src="@/assets/curso/temas/tema3/img3-1.png", alt="Panela empacada")
      .col-lg-8(data-aos="fade-left")
        p La panela es un producto higroscópico, es decir que absorbe o pierde humedad bajo la influencia de las condiciones ambientales, dependiendo de las condiciones climáticas y de las características del producto.
        p La panela tiende a cambiar cuando existe una combinación de azúcar bajo, sacarosa baja y humedad alta. A medida que aumenta el contenido de humedad, la panela se ablanda, cambia de color, aumenta el contenido de azúcar reductor y reduce el contenido de sacarosa; en estas condiciones, puede infectarse fácilmente con parásitos. Si la panela preparada tiene un contenido de humedad entre 7 % y 10 %, debe transportarse, distribuirse y consumirse rápidamente, ya que el almacenamiento a largo plazo destruye su calidad.  A partir del 10 % de humedad, la superficie brilla dado que aparecen pequeñas gotas de melaza; no se puede almacenar en tales condiciones debido al riesgo de invasión microbiana y cambios fisicoquímicos.
        p.mb-0 Los materiales plásticos termo encogibles y las láminas de aluminio plastificado, son aptos para almacenar la panela durante un largo periodo de tiempo ya que no cambian sus propiedades organolépticas. Este concepto hace referencia al número de propiedades físicas de todos los materiales, que los sentidos pueden percibir como, por ejemplo, su sabor, forma, olor, color o temperatura.

    .row.justify-content-center.mb-5
      .col-lg-8(data-aos="flip-up")
        .cajon.color-secundario.p-4(style="background-color: rgba(226, 135, 44, .15)")
          p.mb-0 La panela en bloques se puede empacar en bolsas, cajas de cartón y 
            em film 
            |retráctil. La más recomendable es el cartón, ya que cumple su función de proteger el producto, de la humedad y se puede reutilizar. Si se utilizan bolsas se recomienda el polipropileno biorientado.

    p.mb-5(data-aos="fade-right") A continuación, se detallan los requisitos de empaque para la distribución nacional y exportación de la panela:

    TabsC.color-acento-contenido.mb-5(data-aos="zoom-in")
      .py-4.py-md-5(titulo="Empaque para la distribución a nivel nacional")
    ...
    figure
      .video(data-aos="zoom-in")
        iframe(width="560" height="315" src="https://www.youtube.com/embed/VvxWR0lL-_U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      ...
      .col-lg-8.col-sm-8
        ...
        ImagenInfografica.color-primario(data-aos="zoom-in")
          template(v-slot:imagen)
            figure
              img(src='@/assets/curso/temas/tema3/img3-5.svg', alt='Almacenamiento de la panela')
          .tarjeta.cftpc1.p-3(x="20%" y="8%" numero="")
            p Apilar ordenadamente o en tarimas con un buen espacio libre entre paredes y pisos.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-2(data-aos="fade-right")
        figure
          img(src='@/assets/curso/temas/tema3/img3-7.svg', alt='Panelas')
      .col-lg-10(data-aos="fade-left")
        p Los factores que afectan la absorción de humedad y la consiguiente disminución de la calidad de la panela están relacionados con su estructura y entorno. Es muy peligroso si es demasiado bajo en azúcar, bajo en sacarosa y alto en humedad.
        p.mb-0 A medida que aumenta la higroscopicidad, la panela se vuelve blanda, cambia de color, disminuye el contenido de azúcar, disminuye la sacarosa, aparecen bacterias.
    ...
    .row.justify-content-center.mb-5
      .col-lg-10.col-sm-9
        ...
        ImagenInfografica.color-primario
          template(v-slot:imagen)
            figure
              img(src='@/assets/curso/temas/tema3/img3-8.svg', alt='Mantenimiento de la panela')
          .tarjeta.cftpc1.p-3(x="14%" y="77%" numero="")
            p Comienza externamente en la panela y avanza hasta invadir totalmente, acentuándose cuando el producto se fracciona debido a una mayor área de exposición.
          .tarjeta.cftpc2.p-3(x="50%" y="77%" numero="")
            p El tono claro vuelve al verdoso, que había sido eliminado por el Na2S2O4, debido al paso del complejo ferroso a férri­co por oxidación al con­tacto con el aire. Así mismo, aún en panela sin aditivos químicos se presenta oscurecimiento del producto por acción de la luz.
    ...
    .row.justify-content-center.mb-5
      .col-lg-8
        AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta--gris1")
          .row.justify-content-center(titulo="Normatividad de empacado y embalaje")
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-2.mb-sm-4
        figure
          img(src='@/assets/curso/temas/tema3/img3-10.svg', alt='Comercio')
      .col-lg-10
